...
#!/bin/bash
# =============================================================================
# desktop_appdata_sync
# Deterministic, atomic, auditable desktop appdata backup script via SMB.
...
# CONSTANTS
# =============================================================================
readonly SCRIPT_NAME="desktop_appdata_sync"
...
readonly MOUNT_POINT="/mnt/user/data/computer/backups/vms appdata"
...
send_discord_error() {
    send_discord_message "DESKTOP APPDATA SYNC ERROR" "$1" 15158332
}
...
# Skips silently if source does not exist (remote app may not be installed).
...
backup_file() {
    ...
    # Remove stale copy before replacing
    rm -f "$dest_file"
...
main() {
    ...
    # Remove Discord cache dirs after sync (they're excluded from rsync but may exist from prior runs)
