...
# =============================================================================
# dirtree_weekly
# Deterministic, atomic, auditable weekly directory tree report script.
...
# CONSTANTS
# =============================================================================
readonly SCRIPT_NAME="dirtree_weekly"
...
readonly MOUNT_POINT="/mnt/user/data/computer/unraidstuff/dirtree/weekly"
readonly DIRTREE_SCRIPT="/mnt/user/data/computer/unraidstuff/dirtree_weekly.py"
...
send_discord_error() {
    send_discord_message "DIRTREE WEEKLY ERROR" "$1" 15158332
}

send_discord_success() {
    send_discord_message "DIRTREE WEEKLY" "$1" 3066993
}
...
main() {
    ...
    log_section "Running dirtree weekly Python script"
    ...
    if python3 "$DIRTREE_SCRIPT" 2>&1 | tee -a "$LOG_FILE"; then
        log_info "Dirtree weekly script completed successfully"
    else
        log_error "Dirtree weekly script exited with non-zero status"
    fi
