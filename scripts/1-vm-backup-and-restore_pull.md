...
if mountpoint -q "/mnt/remotes/devunraid_dev_files"; then
    echo "****Devunraid dev_files share is mounted successfully, proceeding with VM Backup & Restore copy****"

# Options: 1-latest, 2-second, 3-third, 4-fourth, 5-fifth
RESTORE_VERSION="01-latest"

# Paths
BACKUP_BASE="/mnt/remotes/devunraid_dev_files/vm-backup-and-restore"
TARGET_DIR="/usr/local/emhttp/plugins/vm-backup-and-restore"
...
# RESTORE PROCESS
# ===============================
echo "Restoring VM Backup & Restore from backup: $SRC_DIR → $TARGET_DIR"
