...
if mountpoint -q "/mnt/remotes/devunraid_dev_files"; then
    echo "****Devunraid dev_files share is mounted successfully, proceeding with flash-backup copy****"

# Options: 1-latest, 2-second, 3-third, 4-fourth, 5-fifth
RESTORE_VERSION="02-second"

# Paths
BACKUP_BASE="/mnt/remotes/devunraid_dev_files/flash-backup"
TARGET_DIR="/usr/local/emhttp/plugins/flash-backup"
...
# RESTORE PROCESS
# ===============================
echo "Restoring Flash Backup from backup: $SRC_DIR → $TARGET_DIR"
