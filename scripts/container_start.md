...
# return non-zero on benign conditions (already running, etc.).
...
# CONSTANTS
# =============================================================================
readonly SCRIPT_NAME="container_start"
...
rotate_logs() {
    ...
    # Prune oldest logs beyond retention cap
    local num_logs
...
# Uses global LAST_CONNECTIVITY_RESULT to avoid subshell capture bugs:
#   - Subshell $() would discard ERRORS mutations
#   - log_info/log_error stdout would pollute a captured return value
# =============================================================================
